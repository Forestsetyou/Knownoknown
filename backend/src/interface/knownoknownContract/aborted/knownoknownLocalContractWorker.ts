...
export class KnownoknownLocalContractWorker {
    ...
    private async initContractFields() {
        ...
        if(this.zkApp.applicationEntryMerkleRoot.get().equals(dagRoot)) {
...
const knownoknownLocalContractWorker = new KnownoknownLocalContractWorker();
comlink.expose(knownoknownLocalContractWorker, nodeEndpoint(parentPort));
